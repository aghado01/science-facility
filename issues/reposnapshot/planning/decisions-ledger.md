...
| 11 | Bidi controls U+202A–U+202E / U+2066–U+2069 | Invisible **and** make source display differently from how it executes — the failure mode that matters most for a payload meant to be read. Unaddressed | **open** | format-ws docstring |
