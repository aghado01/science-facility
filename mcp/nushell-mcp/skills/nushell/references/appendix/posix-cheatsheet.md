...
Displaced from `posix-cheatsheet`; console equivalent: [`nu-skills read posix-cheatsheet`](../posix-cheatsheet.md).
...
| **Redirect Stderr / Complete** | `do { cmd } \| complete` | See [`nu-skills read appendix/advanced`](advanced.md) |
| **Prepend to PATH** | `$env.PATH = ($env.PATH \| prepend "/dir")` | See [`nu-skills read appendix/parity`](parity.md) |
