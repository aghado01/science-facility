...
- [Spine & Routing](file:///D:/aghado01/science-facility/utils/reposnapshot/reposnapshot-v3/docs/spine-and-routing.md) — Canonical stage spine, meta-token routing tables, per-file-class plan families, and variant dispatch for heterogeneous ingests. *(Target shape.)*
