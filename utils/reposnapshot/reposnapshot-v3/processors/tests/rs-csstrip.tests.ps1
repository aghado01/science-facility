...
.DESCRIPTION
    ...
    Filed with the 6d harmonization (2026-07-29): rs-csstrip had NO suite when
    its item contract changed, so this covers both the harmonized contract and
    the stripping behavior it had been carrying untested since the copy-over.
    ...
    Coverage:
      ...
      4. Standalone vs interior block comments (span expansion difference)
      5. CommentBlock reclassification (2+ contiguous // lines)
      6. DocString /// vs // discrimination
      7. CRLF normalization side effect (documented behavior)
      8. Empty content / empty Operations
      9. IncludeMeta = $false — suppresses the Processing record; a bag stays a bag
     10. Harmonized content-mutator contract (6d) — identity survival,
         copy-on-mutate, Text-key preservation, no-content pass-through,
         Processing trail

.NOTES
    Run from any directory:
        & "$PSScriptRoot\rs-csstrip.tests.ps1"
#>
...
# ---------------------------------------------------------------------------
# Fixture — one of each comment kind
# ---------------------------------------------------------------------------
$fixture = @'
/* standalone block
   second line */
...
# ============================================================
# 4. Standalone vs interior block span handling
# ============================================================
...
# ============================================================
# 5. CommentBlock reclassification
# ============================================================
...
# ============================================================
# 6. DocString vs LineComment discrimination
# ============================================================
...
# ============================================================
# 10. Harmonized content-mutator contract (consolidation 6d)
# ============================================================
